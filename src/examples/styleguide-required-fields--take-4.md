...
pageTitle: Styleguide | Required Fields | Take 4
eleventyNavigation:
  key: required-fields-4
  title: Styleguide - Required Fields - Take 4
  parent: examples
---
...
<fieldset>
  ...
  <div class="helptext"><span class="required">Obligatorisk</span>Choose all that apply.</div>
  <ul>
