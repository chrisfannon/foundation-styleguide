var tool = Vue.component( 'toolbar-tool', {
  ...
  template: `
    <div>
      <button v-for="icon in icons" class="button clear dark" :name="icon.name" v-show="selectedItem == icon.name" v-html="icon.svg"></button>
    </div>
  `,
  data: function() {
    return {
...
var app = new Vue({
  el: '#root',
  data : {
    tool1Option: 'infoclick1',
    toolNames: [ 'infoclick1', 'infoclick2', 'drill1', 'drill2' ]
  },
  methods: {
