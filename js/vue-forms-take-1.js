...
var checkbox = Vue.component( 'check-box', {
  ...
  template: `
    <div>
      <input type="checkbox" :id="myData.id" />
      <label :for="myData.id">
        <span>{{ myData.label }}</span> 
        <span class="required" v-show="myData.isRequired">Obligatorisk</span>
      </label>
    </div>
  `
})
...
var textfield = Vue.component( 'text-field', {
  ...
  template: `
    <div>
      <label :for="myData.id" aria-label="Obligatorisk fält. Min andra etikett">{{ myData.label }} <span class="required" v-show="myData.isRequired">Obligatorisk</span></label>
      <div class="helptext" v-show="myData.helpText" v-html="myData.helpText"></div>
      <input type="text" :id="myData.id" />
    </div>
  `
})
...
var app = new Vue({
  ...
  data : {
    fieldData : [
      {
        id : "123",
        label : "My Label from Data",
        isRequired : "true",
        helpText : "<p>Here is some important information that will give you necessary context to successfully fill out this field.</p>",
        ariaLabel : "Obligatorisk fält. Min andra etikett"
      },
      {
        id : "456",
        label : "My Checkbox Label from Data",
        isRequired : "true",
        helpText : "",
        ariaLabel : "Obligatorisk fält. My checkbox label from data"
      }
    ],
    isEditor : "false",
    icons: [
